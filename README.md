<img src="assets/logo.png" alt="My Photo" style="width:10%; height:auto;" />
...
## Core Systems
### Themes
Themes will be customisable and modular, defined by a rigid set of QML and/or abstracted methods. Default themes will include:
- Dark (Default)
- Light
- High Contrast
...
|ElementColor|Colour|For non selected UI elements (e.g. non focues pills)|
